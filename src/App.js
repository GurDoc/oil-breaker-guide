...
const breakers = [
  {
    ...
    oilBufferStroke: "Около 21",
    oilBufferLevel: "47",
    angleOfDrive: "87+2/-2°",
    resistance: "50/40/35 мкОм",
    speedOnTouch: "3.6+0.5/-0.5 м/с",
    fullSpeedOn: "<=4.5 м/с",
  ...
  {
    model: "ВМГ-10",
    fullStroke: "210+5/-5 мм",
    movingContactStroke: "45+5/-5 мм",
    spareStroke: "25+5/-5 мм",
    contactTouchDifference: "<=5 мм",
    springBufferStroke: "Не указано",
    springBufferGap: "Не указано",
    oilBufferStroke: "20+1/-1 мм",
    oilBufferLevel: "45 мм",
    angleOfDrive: "90+2/-2°",
    resistance: "78 мкОм",
    speedOnTouch: "2.3 м/с",
    fullSpeedOn: "2.3 м/с",
    speedOffTouch: "2.4 м/с",
  ...
  },
  {
    ...
    oilBufferLevel: "До половины корпуса",
    angleOfDrive: "Не указано",
    resistance: "Д.Г. 260/26 мкОм",
    speedOnTouch: "Д.Г. 1.4 м/с",
    fullSpeedOn: "Д.Г. 1.7 м/с",
    speedOffTouch: "Эл. 1.2/ДГ 2.1 м/с",
  ...
  },
  {
    ...
    angleOfDrive: "Не указано",
    resistance: "Д.Г. не более 300 мкОм",
    speedOnTouch: "Д.Г. 2+0.2/-0.2 м/с",
    fullSpeedOn: "Не указано",
    speedOffTouch: "ДГ 1.8+0.2/-0.2 м/с",
  ...
  },
  {
    ...
    springBufferGap: "Не указано",
    oilBufferStroke: "21+1/-1 мм",
    oilBufferLevel: "47 мм",
    angleOfDrive: "90+1/-1°",
    resistance: "Раб. 19,Д.Г. 30,Полн 14 мкОм",
    speedOnTouch: "3.6-4.4 м/с",
    fullSpeedOn: "4+0.4/-0.4 м/с",
    speedOffTouch: "3.1-3.6 м/с",
    fullSpeedOff: "3.8-4.6 м/с"
  },
  {
    ...
    springBufferStroke: "Не указано",
    springBufferGap: "Не указано",
    oilBufferStroke: "19.5 мм",
    oilBufferLevel: "Не указано",
    angleOfDrive: "Не указано",
    resistance: "60/45 мкОм",
    speedOnTouch: "4 м/с",
    fullSpeedOn: "Не указано",
    speedOffTouch: "3.2 м/с",
    fullSpeedOff: "Не указано"
  },
  {
    ...
    oilBufferLevel: "45 мм",
    angleOfDrive: "Не указано",
    resistance: "55/45/32 мкОм",
    speedOnTouch: "4.8/5.2 м/с",
    fullSpeedOn: "Не указано",
    speedOffTouch: "3.2 м/с",
    fullSpeedOff: "Не указано"
  },
        ...
        {filtered.map((b, idx) => (
          <div key={idx} className="card">
            <div className="card-content">
              ...
              <p><strong>Угол поворота вала выключателя:</strong> {b.angleOfDrive}</p>
